...
public class PrincipalDetails implements UserDetails, OAuth2User {
    ...
    public void setUserService(UserService userService) {   // userservice 객체를 주입받기 위한 메서드
    ...
    @Override
    public Collection<? extends GrantedAuthority> getAuthorities() {    // 현재 사용자의 권한을 반환
    ...
    public String getPassword() {
        return user.getPassword();  // PasswordEncoder 를 호출해 password 가 같은지 비교
    }
