...
public class U {
    ...
    public static User getLoggedUser() {
        PrincipalDetails userDetails = (PrincipalDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();  // User 디테일 객체 가져오기
    ...
    public static void printfileInfo(MultipartFile file) {
        ...
        // 이미지 파일 여부 판정 // 이미지 파일의 크기나 사이즈 제약에도 사용 가능
        try {
